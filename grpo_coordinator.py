...
REWARD_CALCULATION_SH = "./examples/grpo_trainer/run_qwen2_5_3b_llm_math_meta_llm_rl.sh"
...
GPUS_PER_UPDATE_TASK = 4 # Rollout
    ...
    for loop_num in range(TOTAL_ITERATIONS):
        ...
        for item in checked_data:
            if item.get('reward') == 0.0:
                ...
                checkpoints_dir = f"./checkpoints/verl_grpo_gsm8k_math_meta_llm_rl_from_sft_dlc/qwen2.5-3b-base_meta_outer_{loop_num}_rollout{rollout_index}/"
                ...
                if os.path.exists(checkpoints_dir):
                    ...
                    continue
                command = ["bash", REWARD_CALCULATION_SH, experiment_name, custom_fn]
